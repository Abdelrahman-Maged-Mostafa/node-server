  ...
  const issues = [
    {
      ...
      key: "BUG-001",
      fields: {
        assignee: { name: "user1", displayName: "User One" },
        created: "2026-01-14T10:00:00.000+0000",
        creator: { name: "admin", displayName: "Admin User" },
        issuetype: { name: "Bug", description: "A problem which impairs or prevents the functions of the product." },
        labels: ["frontend", "urgent"],
        priority: { name: "High" },
        project: { id: "20001", key: "PROJ-ALPHA", name: "Project Alpha" },
        reporter: { name: "qa_team", displayName: "QA Team" },
        resolutiondate: null,
        status: { name: "Open", description: "Issue is open and ready for work" },
    ...
    },
    {
      ...
      key: "TASK-002",
      fields: {
        assignee: { name: "user2", displayName: "User Two" },
        created: "2026-01-13T09:00:00.000+0000",
        creator: { name: "dev_team", displayName: "Dev Team" },
        issuetype: { name: "Task", description: "A task that needs to be done." },
        labels: ["backend"],
        priority: { name: "Medium" },
        project: { id: "20002", key: "PROJ-BETA", name: "Project Beta" },
        reporter: { name: "manager", displayName: "Project Manager" },
